<template>
  <div class="box" v-if="isOne && isImage">
    ...
    <Divider plain orientation="left">
      <h4>{{ $t('ui.imageStroke') }}</h4>
    </Divider>
    <div class="hd-wrap">
      <div class="hd">
        <span>{{ $t('ui.enableImageStroke') }}</span>
        <Poptip trigger="hover" :content="$t('ui.onlySupportPng')">
